...
\newcommand{\bda}[1]{\todo[color=orange!30,inline]{{\bf BDA:} #1}}
...
\rp Fixed. We added more details. Please see Sec. 4.1 of diff.pdf.
...
\rp This might be the solver's issue;
we currently have no idea, but we will consider this in the future if this error largely affects our numerical simulation. 
